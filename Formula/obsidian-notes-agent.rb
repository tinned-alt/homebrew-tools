class ObsidianNotesAgent < Formul
  include Language::Python::Virtualenv

  desc "AI-powered agent for managing Obsidian notes with Claude"
  homepage "https://github.com/tinned-alt/notes-agent/tree/v0.1.0"
  # For local testing, use:
  # url "file:///path/to/notes-agent/dist/obsidian_notes_agent-0.1.0.tar.gz"
  # For GitHub release, use:
  url "https://github.com/tinned-alt/notes-agent.git"
  sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5  release.tar.gz"
  license "MIT"
  head "https://github.com/tinned-alt/notes-agent.git", branch: "main"
